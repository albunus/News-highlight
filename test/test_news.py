...
class SourcesTest(unittest.TestCase):
    ...
    def test_to_check_instance_variables(self):
        ...
        self.assertEquals(self.new_source.description,'Cable News Network that is a leader in providing news worldwide')
    ...
    def setUp(self):
        ...
        Set up method that will run before every Test
        '''
        self.new_article = Articles('CNN','albunus nyalita','The tech scene in Africa-Is it the next big thing?','A look at various tech hubs in Africa and the impact they have on the worlds economy','techie.com','techie.com/7643t94.jpg','2018-04-11T07:57:16Z')
    ...
    def test_to_check_instance_variables(self):
        ...
        self.assertEquals(self.new_article.author,'albunus nyalita')
